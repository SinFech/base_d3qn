...
from rl.algos.sac.trainer import Config, load_config, save_config, train
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Override config values, e.g. --override sac.actor_learning_rate=0.0003",
    )
